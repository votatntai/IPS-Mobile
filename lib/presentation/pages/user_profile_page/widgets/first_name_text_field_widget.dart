        ...
        return Column(
          children: [
            ...
            CustomTextField(
              isEnabled: true,
              onInputText: (_) {
                userProfilePageBloc.add(FirstNameValidationEvent());
              },
              inputType: TextInputType.name,
              inputAction: TextInputAction.next,
              elevation: 0.0,
              textEditingController:
                  userProfilePageBloc.firstNameTextEditingController,
              focusNode: userProfilePageBloc.firstNameFocusNode,
              hintText: 'First name',
            ...
            Visibility(
              visible: userProfilePageBloc.state.firstNameErrorMsg.isNotEmpty,
              child: Padding(
                padding: const EdgeInsets.only(top: 10.0),
                child: Align(
                  alignment: Alignment.centerRight,
                  child: Text(
                    userProfilePageBloc.state.firstNameErrorMsg,
